...
extern pthread_cond_t clientConnect_cond[10];
extern pthread_mutex_t msgTable_mutex,shutDown_mutex,clientConnect_mutex,connection_mutex;
...
extern void printUOID(unsigned char *);
extern void myWriteByte(unsigned char);
extern void myWrite4Bits(unsigned char);
